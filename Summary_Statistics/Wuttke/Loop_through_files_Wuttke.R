...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Wuttke", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Wuttke/"))
...
Sum_Stat_Name <- "Wuttke" #change for each GWAS Summary Statistic
