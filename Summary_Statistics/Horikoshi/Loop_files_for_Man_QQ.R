...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Horikoshi", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Horikoshi/"))
...
Sum_Stat_Name <- "Horikoshi" #change for each GWAS Summary Statistic
