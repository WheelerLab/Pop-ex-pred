...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Malik", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Malik/"))
...
Sum_Stat_Name <- "Malik" #change for each GWAS Summary Statistic
