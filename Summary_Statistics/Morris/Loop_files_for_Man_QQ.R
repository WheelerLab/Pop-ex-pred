...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Morris", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Morris/"))
...
Sum_Stat_Name <- "Morris" #change for each GWAS Summary Statistic
