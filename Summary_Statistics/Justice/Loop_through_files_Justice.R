...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Justice", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Justice/"))
...
Sum_Stat_Name <- "Justice" #change for each GWAS Summary Statistic
