...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Prins", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Prins/"))
...
Sum_Stat_Name <- "Prins" #change for each GWAS Summary Statistic
