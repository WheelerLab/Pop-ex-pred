...
GTEX_files=("Stomach" "Brain_Cerebellar_Hemisphere" "Brain_Caudate_basal_ganglia" "Adipose_Subcutaneous" "Adipose_Visceral_Omentum" "Adrenal_Gland" "Artery_Aorta" "Artery_Coronary" "Artery_Tibial" "Brain_Amygdala" "Brain_Anterior_cingulate_cortex_BA24" "Brain_Cerebellum" "Brain_Cortex" "Brain_Frontal_Cortex_BA9" "Brain_Hippocampus" "Brain_Hypothalamus" "Brain_Nucleus_accumbens_basal_ganglia" "Brain_Putamen_basal_ganglia" "Brain_Spinal_cord_cervical_c-1" "Brain_Substantia_nigra" "Breast_Mammary_Tissue" "Cells_EBV-transformed_lymphocytes" "Cells_Cultured_fibroblasts" "Colon_Sigmoid" "Colon_Transverse" "Esophagus_Gastroesophageal_Junction" "Esophagus_Mucosa" "Esophagus_Muscularis" "Heart_Atrial_Appendage" "Heart_Left_Ventricle" "Kindey_Cortex" "Liver" "Lung" "Minor_Salivary_Gland" "Muscle_Skeletal" "Nerve_Tibial" "Ovary" "Pancreas" "Pituitary" "Prostate" "Skin_Not_Sun_Exposed_Suprapubic" "Skin_Sun_Exposed_Lower_leg"  "Small_Intestine_Terminal_Ileum" "Spleen" "Testis" "Thyroid" "Uterus" "Vagina" "Whole_Blood")
...
do
        ...
        do
                ...
                cp $sum_stat ${pheno}
                output="/home/egeoffroy/Summary_Statistics/Summary_Stats/Wojcik/GTEXv8/${Wojcik}/${i}.csv"
                echo $output
                cd /home/egeoffroy/MetaXcan/software
                /home/egeoffroy/anaconda2/bin/python ./MetaXcan.py --model_db_path /home/pfiorica/data/predixcan/predictors/GTExv8/db_files/eqtl/mashr/mashr_${i}.db --covariance /home/pfiorica/data/predixcan/predictors/GTExv8/db_files/eqtl/mashr/mashr_${i}.txt.gz --gwas_folder ${pheno}/SumStats/ --gwas_file_pattern ".*gz" --snp_column rsid --effect_allele_column Effect-allele --non_effect_allele_column Other-allele --beta_column Beta --pvalue_column P-val --output_file $output
