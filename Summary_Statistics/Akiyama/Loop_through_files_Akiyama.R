...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Akiyama/", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Akiyama"))
...
Sum_Stat_Name <- "Akiyama" #change for each GWAS Summary Statistic
