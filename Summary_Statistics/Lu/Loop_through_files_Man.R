...
all_dir <- list.dirs("/home/egeoffroy/Summary_Statistics/Summary_Stats/Lu", full.names=FALSE)
print(all_dir)
setwd(paste("/home/egeoffroy/Summary_Statistics/Summary_Stats/Lu/"))
...
Sum_Stat_Name <- "Lu" #change for each GWAS Summary Statistic
